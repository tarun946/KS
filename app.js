...
$("#joinForm").addEventListener("submit", async (event) => {
  ...
  $("#formHint").textContent = "Sending your request...";
  ...
  try {
    ...
    $("#formHint").textContent = "Joined successfully. Your queue card is now shown below.";
  } catch (error) {
    $("#formError").textContent = error.message;
    $("#formHint").textContent = "Please check the fields and try again.";
  } finally {
    $("#joinForm button[type='submit']").disabled = false;
  }
});
